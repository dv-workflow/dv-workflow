...
2. Copy `config/dw.config.yml` to your project and fill in your settings
...
- Code review with checklist (see `core/QUALITY.md`)
...
Full quality strategy: `core/QUALITY.md`
...
- Workflow phases: `core/WORKFLOW.md`
